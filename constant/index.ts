...
// app screenshots/videos on social media (agreed to at signup, not a separate
// opt-in), business-account contact sharing, and the enforcement record kept
// after a ban to prevent re-registration. It is written to align with Rwanda's
...
export const PrivacyPolicyData = [
  ...
  },
  {
    ...
    content:
      "We use your personal data only where the law allows. Our legal bases are:\n(1) Performance of a contract with you - to create and run your account, show your profile, match employers and providers, process jobs and bookings, exchange the contact details needed to complete a booking, carry messages, and take payments.\n(2) Your consent - given when you create an account and accept these documents, or later in the app: to use app screenshots and videos that include your public profile in Huza.app's explanatory and promotional material (see section 7), to send you marketing messages, and to use your device location.\n(3) Our legitimate interests - to verify identity, prevent fraud and abuse, keep users safe, enforce our Terms (including preventing banned users from re-registering), respond to disputes, and analyse and improve the platform, in a way that does not override your rights.\n(4) Legal obligation - to keep records and respond to lawful requests from courts or authorities in Rwanda.",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    content:
      "To explain how Huza.app works, to create training and educational material, and to promote the service and the people who offer services on it, Huza.app captures screenshots and screen recordings of the app and shares them, including on social media.\nThese may show your public profile as it appears in the app - your photo, name, and listing details. They do not include your phone number, email address, or ID document.\nBy creating an account you agree that Huza.app may use this kind of app content, including where you are visible in it, for these purposes. If Huza.app wants to feature you specifically - for example a post highlighting you as a provider - we will let you know.\nIf you would prefer not to appear in this kind of content, email support@huza.app. We will avoid featuring you and will remove you from, or blur you in, material we control going forward. Content that has already been published, or that other people have re-shared, may remain.",
  },
  {
    id: 8,
