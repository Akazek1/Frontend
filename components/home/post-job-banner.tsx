...
const PostJobBanner: React.FC = () => {
  ...
  return (
    <div
      ...
      className="flex items-center gap-3 bg-white border border-brand/20 rounded-2xl px-4 py-2.5 shadow-sm hover:shadow-md transition-shadow duration-200 cursor-pointer"
    >
      ...
      <span className="text-[10px] font-semibold text-brand whitespace-nowrap flex-shrink-0">
        Post →
      </span>
    </div>
  );
