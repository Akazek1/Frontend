  ...
  return (
    <section className="flex flex-col items-center rounded-2xl border border-dashed border-[#DCEEDD] bg-white px-6 py-12 text-center">
      <div className="flex h-14 w-14 items-center justify-center rounded-full bg-[#F1FCEF]">
        <PackageOpen className="h-7 w-7 text-[#145B10]" aria-hidden="true" />
      </div>
      <h3 className="mt-4 text-[16px] font-black text-[#1B2431]">
      ...
      <Button
        type="button"
        onClick={onAdd}
        className="mt-5 bg-[#145B10] text-white hover:bg-[#0F4D0C]"
      >
